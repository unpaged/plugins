...
The [Codex connection and visual-plan readiness runbook](docs/codex-connection-readiness.md)
tracks native installation/recovery and the complete plan, review, implementation,
and as-built workflow. It is a maintainer acceptance guide; it does not claim
public Codex availability or completed installed-host trials.
