...
test("concurrent publishers retain one complete private runtime without connection or state files", async (t) => {
  ...
  assert.deepEqual((await readdir(join(root, "runtime"))).sort(), ["cli.mjs", "control.mjs", "handover.mjs", "mcp.mjs", "poll.mjs", "process-identity.mjs", "protocol.mjs", "setup.mjs", "snapshot.mjs", "store.mjs", "worker.mjs"]);
