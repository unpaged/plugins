...
import { acceptancePhrase, CODEX_PATH, EVENTS_URL, parseEvent, validateBinding, validateEvidence } from "./protocol.mjs";

const binding = { documentId: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa", threadId: "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",
  keyId: "listener-key", url: EVENTS_URL, protocols: ["unpaged-listener.v1", "TEST_SECRET"], codexPath: CODEX_PATH, planDigest: "a".repeat(64) };
